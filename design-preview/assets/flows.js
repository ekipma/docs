...
window.createPastelFlows = function (app) {
  ...
  const fresh = () => ({hideZero:false, profile:{name:'Hayyaun',email:'hayyaun@example.com',photo:''},
    ...
    authPhone:'', authMethod:'', authDestination:'', authKey:'', knownAuth:{}, signup:false, authError:'', otpError:'', sync:'online', clear:false, id:10, review:null});
  let ui = fresh();
